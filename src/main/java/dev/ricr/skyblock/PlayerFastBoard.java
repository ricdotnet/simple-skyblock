...
public class PlayerFastBoard {
    ...
    public void updateWorldTime() {
        ...
        var currentTimeLine = String.format("<green>⌚ <white>Time <green>%s", ServerUtils.longToTime(currentTime));
    ...
    public void updateWorld(String worldName) {
        var worldLine = String.format("<blue>\uD83C\uDF0D <white>World <green>%s", worldName);
